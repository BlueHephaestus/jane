...
"""
Live Stock Environment, where it's treated as a RL environment which will only return the next result
    after a new input. Meant to emulate a real-time environment.
